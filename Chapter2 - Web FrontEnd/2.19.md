...
3. 然后编写一个 world.js 和 一个 style.css ，然后进行打包
   ...
   ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/WX20180802-095124@2x.png)
...
6. 查看网页效果。发现函数确实执行了，背景颜色也生效了，我们写的 css 代码新建了一个 **style标签** 被直接写入到 html 中了。
   ...
   ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/WX20180802-100727@2x.png)
...
11. 如果像看到打包的模块，可以使用 **--display-modules**
    ...
    ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/WX20180802-103343@2x.png)
...
12. 如果想知道打包某个模块的原因，可以使用 **--display-reasons**
    ...
    ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/WX20180802-103717@2x.png)
...
2. 有了 webpack.config.js 文件，就不需要和上面的方式一样，指定对应的 configuration option。在终端运行 **webpack --mode=development **
   ...
   ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/QQ20180802-110653@2x.png)

3. 注意：如果我们将 webpack.config.js 改名为 webpack.dev.config.js ，然后在命令行打包，会发现没效果。

   ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/QQ20180802-110938@2x.png)

   ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/QQ20180802-111011@2x.png)
   ...
   ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/QQ20180802-111143@2x.png)
...
4. 如果想像上个实验一样，看到打包时候的一些信息，怎么办呢？
   ...
   ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/QQ20180802-113022@2x.png)
...
6. 如果指定了多个入口，那么执行打包会报错，因为 webpack 文档说如果多个 entry，且只有一个 output 的 filename，那么打包的结果会覆盖。所以我们需要设置如下
   ...
   ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/QQ20180802-120033@2x.png)

   将文件修改为 **filename: '\[name\]-\[chunkhash\].js'**

   ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/QQ20180802-120113@2x.png)
...
3. 处理模版
   ...
   ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/WX20180803-152208@2x.png)
   ...
   - ejs 模版
     ...
     new App()
     ```
     ![](https://github.com/FantasticLBP/knowledge-kit/blob/master/assets/WX20180803-152612@2x.png)
